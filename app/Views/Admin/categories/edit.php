...
<head>
    ...
    <title>Edit Category - NextCafe</title>
            ...
            <div class="card-wrapper" style="max-width: 600px; margin: 0 auto;">
                <form action="<?= base_url('admin/categories/update/' . $category->id) ?>" method="POST">
                    <div style="margin-bottom: 1.5rem;">
                        ...
                        <input type="text" name="name" value="<?= esc($category->name) ?>" required style="width: 100%; padding: 0.75rem; border: 1px solid #ddd; border-radius: 8px;">
                    </div>
                    <div style="margin-bottom: 1.5rem;">
                    ...
                    <div style="display: flex; gap: 1rem; justify-content: flex-end;">
                        ...
                        <button type="submit" class="btn-primary" style="padding: 0.75rem 1.5rem; border: none; cursor: pointer; border-radius: 8px;">Update Category</button>
                    </div>
                </form>
            </div>
        </div>
